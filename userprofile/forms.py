...
class LawyerDataForm(forms.ModelForm):
    class Meta:
        model = Lawyer_Data
        fields = 'lawyerID', 'lawyer_name', 'access_code', 'phone', 'hourlyrate', 'IBPRollNo', 'IBPChapter','IBPLifetimeNo', 'Specialization', 'remarks'
        Widget = {
            ...
            'hourlyrate' : NumberInput(attrs={"class": "form-control", "inputmode": "decimal"}),
