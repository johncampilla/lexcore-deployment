...
# Accounts Receivables
    ...
    prev_bill_amount = AccountsReceivable.objects.filter(bill_date__year = prev_year, bill_date__month = prev_month).exclude(payment_tag="CN").aggregate(Sum('total_USDamount'))
    ...
    prev_peso_amount = AccountsReceivable.objects.filter(bill_date__year =prev_year, bill_date__month = prev_month).exclude(payment_tag="CN").aggregate(Sum('total_PhPamount'))
